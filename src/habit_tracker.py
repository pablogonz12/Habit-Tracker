...
class HabitTracker:
    ...
    reward_costs = {
        # Using lowercase as reward costs are class variables that might need
        # to be adjusted for game balancing purposes
        'easy': 50,
        'medium': 100,
        'hard': 150
    }
    ...
    def delete_reward(self, name):
        """
        Deletes a reward from the list of rewards based on its name.

        Args:
            name (str): The name of the reward to be deleted.
        """
